...
class UserControllerIntegrationTests {
    ...
    void updatePassword_ShouldReturnForbidden_WhenTryingToUpdateOtherUser() throws Exception {
        PasswordTestDTO dto = new PasswordTestDTO("password123", "anotherPassword");
